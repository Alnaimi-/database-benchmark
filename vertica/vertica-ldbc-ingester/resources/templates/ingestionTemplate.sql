...
copy place from local '{{ LDBC_LOCATION }}/place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy place_isPartOf_place from local '{{ LDBC_LOCATION }}/place_isPartOf_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy organisation from local '{{ LDBC_LOCATION }}/organisation_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy organisation_isLocatedIn_place from local '{{ LDBC_LOCATION }}/organisation_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy city from local '{{ LDBC_LOCATION }}/city_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy country from local '{{ LDBC_LOCATION }}/country_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy continent from local '{{ LDBC_LOCATION }}/continent_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy company from local '{{ LDBC_LOCATION }}/company_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy university from local '{{ LDBC_LOCATION }}/university_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy tag from local '{{ LDBC_LOCATION }}/tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy tagclass from local '{{ LDBC_LOCATION }}/tagclass_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy tagclass_isSubclassOf_tagclass from local '{{ LDBC_LOCATION }}/tagclass_isSubclassOf_tagclass_0_0.csv' with DELIMITER '|'ABORT ON ERROR SKIP 1;
copy tag_hasType_tagclass from local '{{ LDBC_LOCATION }}/tag_hasType_tagclass_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment from local '{{ LDBC_LOCATION }}/comment_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_hasCreator_person from local '{{ LDBC_LOCATION }}/comment_hasCreator_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_hasTag_tag from local '{{ LDBC_LOCATION }}/comment_hasTag_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_isLocatedIn_place from local '{{ LDBC_LOCATION }}/comment_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_replyOf_comment from local '{{ LDBC_LOCATION }}/comment_replyOf_comment_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post from local '{{ LDBC_LOCATION }}/post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post_isLocatedIn_place from local '{{ LDBC_LOCATION }}/post_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post_hasTag_tag from local '{{ LDBC_LOCATION }}/post_hasTag_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post_hasCreator_person from local '{{ LDBC_LOCATION }}/post_hasCreator_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_replyOf_post from local '{{ LDBC_LOCATION }}/comment_replyOf_post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum from local '{{ LDBC_LOCATION }}/forum_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_hasTag_tag from local '{{ LDBC_LOCATION }}/forum_hasTag_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_hasModerator_person from local '{{ LDBC_LOCATION }}/forum_hasModerator_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_hasMember_person from local '{{ LDBC_LOCATION }}/forum_hasMember_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_containerOf_post from local '{{ LDBC_LOCATION }}/forum_containerOf_post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person from local '{{ LDBC_LOCATION }}/person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_knows_person from local '{{ LDBC_LOCATION }}/person_knows_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_isLocatedIn_place from local '{{ LDBC_LOCATION }}/person_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_hasInterest_tag from local '{{ LDBC_LOCATION }}/person_hasInterest_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_email_emailaddress from local '{{ LDBC_LOCATION }}/person_email_emailaddress_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_workAt_organisation from local '{{ LDBC_LOCATION }}/person_workAt_organisation_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_studyAt_organisation from local '{{ LDBC_LOCATION }}/person_studyAt_organisation_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_speaks_language from local '{{ LDBC_LOCATION }}/person_speaks_language_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_likes_post from local '{{ LDBC_LOCATION }}/person_likes_post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_likes_comment from local '{{ LDBC_LOCATION }}/person_likes_comment_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
