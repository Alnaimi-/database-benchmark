...
copy place from local '/data/ldbc_complete/completeLDBC/30G/social_network/place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy place_isPartOf_place from local '/data/ldbc_complete/completeLDBC/30G/social_network/place_isPartOf_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy organisation from local '/data/ldbc_complete/completeLDBC/30G/social_network/organisation_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy organisation_isLocatedIn_place from local '/data/ldbc_complete/completeLDBC/30G/social_network/organisation_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy city from local '/data/ldbc_complete/completeLDBC/30G/social_network/city_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy country from local '/data/ldbc_complete/completeLDBC/30G/social_network/country_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy continent from local '/data/ldbc_complete/completeLDBC/30G/social_network/continent_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy company from local '/data/ldbc_complete/completeLDBC/30G/social_network/company_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy university from local '/data/ldbc_complete/completeLDBC/30G/social_network/university_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy tag from local '/data/ldbc_complete/completeLDBC/30G/social_network/tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy tagclass from local '/data/ldbc_complete/completeLDBC/30G/social_network/tagclass_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy tagclass_isSubclassOf_tagclass from local '/data/ldbc_complete/completeLDBC/30G/social_network/tagclass_isSubclassOf_tagclass_0_0.csv' with DELIMITER '|'ABORT ON ERROR SKIP 1;
copy tag_hasType_tagclass from local '/data/ldbc_complete/completeLDBC/30G/social_network/tag_hasType_tagclass_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment from local '/data/ldbc_complete/completeLDBC/30G/social_network/comment_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_hasCreator_person from local '/data/ldbc_complete/completeLDBC/30G/social_network/comment_hasCreator_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_hasTag_tag from local '/data/ldbc_complete/completeLDBC/30G/social_network/comment_hasTag_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_isLocatedIn_place from local '/data/ldbc_complete/completeLDBC/30G/social_network/comment_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_replyOf_comment from local '/data/ldbc_complete/completeLDBC/30G/social_network/comment_replyOf_comment_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post from local '/data/ldbc_complete/completeLDBC/30G/social_network/post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post_isLocatedIn_place from local '/data/ldbc_complete/completeLDBC/30G/social_network/post_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post_hasTag_tag from local '/data/ldbc_complete/completeLDBC/30G/social_network/post_hasTag_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy post_hasCreator_person from local '/data/ldbc_complete/completeLDBC/30G/social_network/post_hasCreator_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy comment_replyOf_post from local '/data/ldbc_complete/completeLDBC/30G/social_network/comment_replyOf_post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum from local '/data/ldbc_complete/completeLDBC/30G/social_network/forum_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_hasTag_tag from local '/data/ldbc_complete/completeLDBC/30G/social_network/forum_hasTag_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_hasModerator_person from local '/data/ldbc_complete/completeLDBC/30G/social_network/forum_hasModerator_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_hasMember_person from local '/data/ldbc_complete/completeLDBC/30G/social_network/forum_hasMember_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy forum_containerOf_post from local '/data/ldbc_complete/completeLDBC/30G/social_network/forum_containerOf_post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_knows_person from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_knows_person_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_isLocatedIn_place from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_isLocatedIn_place_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_hasInterest_tag from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_hasInterest_tag_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_email_emailaddress from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_email_emailaddress_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_workAt_organisation from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_workAt_organisation_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_studyAt_organisation from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_studyAt_organisation_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_speaks_language from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_speaks_language_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_likes_post from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_likes_post_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
copy person_likes_comment from local '/data/ldbc_complete/completeLDBC/30G/social_network/person_likes_comment_0_0.csv' with DELIMITER '|' ABORT ON ERROR SKIP 1;
